...
export const envConfigs: ConfigMap = {
  ...
  app_name: process.env.NEXT_PUBLIC_APP_NAME ?? 'AI Wallpaper',
  app_description: process.env.NEXT_PUBLIC_APP_DESCRIPTION ?? 'Generate stunning AI wallpapers with just a text prompt',
